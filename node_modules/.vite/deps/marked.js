...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = i.text) : t.push(r);
  ...
  inlineTokens(e, t = []) {
    ...
    for (; e; ) {
      ...
      s || (r = ""), s = false;
      let i;
      if ((_d = (_c = this.options.extensions) == null ? void 0 : _c.inline) == null ? void 0 : _d.some((a) => (i = a.call({ lexer: this }, e, t)) ? (e = e.substring(i.raw.length), t.push(i), true) : false)) continue;
...
var P = class {
  ...
  code({ text: e, lang: t, escaped: n }) {
    var _a2;
    let s = (_a2 = (t || "").match(m.notSpaceStart)) == null ? void 0 : _a2[0], r = e ? e.replace(m.endingNewline, "") + `
` : "";
