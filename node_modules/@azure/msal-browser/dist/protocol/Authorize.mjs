...
'use strict';
import { createClientConfigurationError, ClientConfigurationErrorCodes, invokeAsync, RequestParameterBuilder, Constants, AuthorizeProtocol, ThrottlingUtils, ResponseHandler, PerformanceEvents, TimeUtils, ProtocolMode, AADServerParamKeys, ProtocolUtils } from '@azure/msal-common/browser';
...
async function getStandardParameters(config, authority, request, logger, performanceClient) {
    ...
    if (request.authenticationScheme === Constants.AuthenticationScheme.DPOP &&
        request.dpopJkt) {
